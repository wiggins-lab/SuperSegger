...
r_center = Mrot*([mean(xxx(xind)),mean(yyy(yind))]'-(ss(2:-1:1))'/2)+(ss_mask(2:-1:1)/2+celld.r_offset-[0.5,0.5])';
...
% as well as axes inside the cell... which are really useful for debugging
% the code.
xaxisx = ...
    [ e1(1)*len(1),...
