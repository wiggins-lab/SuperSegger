function info = cellprops3( mask, props, CONST )
...
info = [L1*pixelFactor, ...
    ...
    s2*pixelFactor, ...
    s3*pixelFactor, ...
    RoundIndOver*pixelFactor, ...
    RoundIndUnder*pixelFactor, ...
    props.Area*pixelFactor.^2, ....
    stm1, ... % angles
    sa1, ...
    sa2, ...
    sa3, ...
    sa4, ...
    1/L1/pixelFactor, ...
    1/L2mean/pixelFactor,...
    minWidthEnd * pixelFactor,... % something wrong?
    sqmin*pixelFactor,...
    sqmax*pixelFactor];
