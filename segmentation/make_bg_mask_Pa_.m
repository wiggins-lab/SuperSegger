...
%imshow( cat(3, ag( mask), ag( mask_mod), 0*ag( and(~mask,~mask_mod_20))));
...
%masks    = ~imdilate(mask,strel('disk',5));
...
%xx = [ 111.6081,  95, 77.7432 0, 0];
%yy = [256, 23.7536,  13.9384, 12.9384, 256];
